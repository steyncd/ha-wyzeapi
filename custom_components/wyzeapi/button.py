...
async def async_setup_entry(
    ...
    for device in irrigation_devices:
        ...
        # Add device-level control buttons
...
class WyzeIrrigationPauseButton(ButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        This method is called when the button is pressed in Home Assistant.
        It will pause the current irrigation without canceling it.

        Raises:
            HomeAssistantError: If the irrigation cannot be paused.
        """
        try:
...
class WyzeIrrigationResumeButton(ButtonEntity):
    ...
    async def async_press(self) -> None:
        ...
        This method is called when the button is pressed in Home Assistant.
        It will resume a previously paused irrigation.

        Raises:
            HomeAssistantError: If the irrigation cannot be resumed.
        """
        try:
